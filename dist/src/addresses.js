...
exports.getLinkEthPriceFeedAddress = exports.getLinkTokenAddress = void 0;
// Returns LINK token contract address for the specified chain.
function getLinkTokenAddress(chainID) {
    switch (chainID) {
...
exports.getLinkTokenAddress = getLinkTokenAddress;
// Returns LINK/ETH price feed contract address for the specified chain.
function getLinkEthPriceFeedAddress(chainID) {
    switch (chainID) {
        case 1: // Ethereum Mainnet
...
exports.getLinkEthPriceFeedAddress = getLinkEthPriceFeedAddress;
